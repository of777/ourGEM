...
# model "ourGEM"
$MY_PYTHON main.py $MNIST_ROTA --model ourGem --lr 0.1 --n_memories 256 --memory_strength 0.5
$MY_PYTHON main.py $MNIST_PERM --model ourGem --lr 0.1 --n_memories 256 --memory_strength 0.5
$MY_PYTHON main.py $CIFAR_100i --model ourGem --lr 0.1 --n_memories 256 --memory_strength 0.5
